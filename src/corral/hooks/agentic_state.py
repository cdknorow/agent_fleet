...
appropriate agent to parse it, and send the resulting event to the Corral
dashboard API.
"""
...
from corral.hooks.utils import corral_api, debug_log, resolve_agent_type, resolve_session_id
...
def main():
    ...
    # Send event to the Corral dashboard
    corral_api(base, "POST", f"/api/sessions/live/{agent_name}/events", {
